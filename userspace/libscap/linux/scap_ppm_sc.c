...
static const ppm_sc_code *g_events_to_sc_map[] = {
	...
	[PPME_SYSCALL_PROCESS_VM_READV_E] = (ppm_sc_code[]){PPM_SC_PROCESS_VM_READV, -1},
	[PPME_SYSCALL_PROCESS_VM_READV_X] = (ppm_sc_code[]){PPM_SC_PROCESS_VM_READV, -1},
	[PPME_SYSCALL_PROCESS_VM_WRITEV_E] = (ppm_sc_code[]){PPM_SC_PROCESS_VM_WRITEV, -1},
	[PPME_SYSCALL_PROCESS_VM_WRITEV_X] = (ppm_sc_code[]){PPM_SC_PROCESS_VM_WRITEV, -1},
	[PPME_SYSCALL_DELETE_MODULE_E] = (ppm_sc_code[]){PPM_SC_DELETE_MODULE, -1},
	[PPME_SYSCALL_DELETE_MODULE_X] = (ppm_sc_code[]){PPM_SC_DELETE_MODULE, -1},
};
